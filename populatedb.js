...
async function createGenres() {
  ...
  await Promise.all([genreCreate('Fantasy'), genreCreate('Science Fiction'), genreCreate('French Poetry')])
}
...
async function createBookInstances() {
  ...
  await Promise.all([
    ...
    bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', false, 'Available'),
    bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', false, 'Available'),
    bookInstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', false, 'Available'),
    bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Available'),
    bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Maintenance'),
    bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Loaned'),
